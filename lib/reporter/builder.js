...
module.exports.createHtmlReport = function() {
  ...
  var source = fs.readFileSync('node_modules/moonraker/lib/reporter/assets/template.html');
...
function copyCss() {
  fs.writeFileSync(path.join(config.resultsDir, 'style.css'),
    fs.readFileSync('node_modules/moonraker/lib/reporter/assets/style.css'));
}
